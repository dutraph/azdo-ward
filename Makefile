# Makefile for azdo-ward — generated from the tui-cli-pattern skill.
...
help:
	@echo "azdo-ward — built with the tui-cli-pattern skill"
	@echo ""
	@echo "Common targets:"
...
build:
	...
	go build -ldflags '$(STRIP_LD) -X github.com/dutraph/azdo-ward/internal/version.Version='"$$v" -o $(BIN) $(PKG)
...
install:
	...
	go build -ldflags '$(STRIP_LD) -X github.com/dutraph/azdo-ward/internal/version.Version='"$$new" -o $(BIN) $(PKG); \
